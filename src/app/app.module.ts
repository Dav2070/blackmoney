...
import { SelectProductSpecialDialogComponent } from "./dialogs/select-product-special-dialog/select-product-special-dialog.component"
...
@NgModule({
	declarations: [
		...
		SelectProductSpecialDialogComponent,
