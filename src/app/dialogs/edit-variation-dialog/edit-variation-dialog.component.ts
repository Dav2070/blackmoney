...
@Component({
	...
	templateUrl: "./edit-variation-dialog.component.html",
	styleUrls: ["./edit-variation-dialog.component.scss"],
	standalone: false
})
export class EditVariationDialogComponent {
	...
	show(variation: Variation) {
		...
		this.variationItems = JSON.parse(
			JSON.stringify(variation.variationItems || [])
		)
		this.visible = true
	}
