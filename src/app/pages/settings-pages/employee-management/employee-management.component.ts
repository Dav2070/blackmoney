...
export class EmployeeManagementComponent {
	...
	saveEditEmployee() {
		if (
			this.editEmployee &&
			this.editEmployeeName.trim() &&
			this.editEmployeePin.trim() &&
			this.editEmployeeRoleUuid
		) {
			...
			this.editEmployee.extraPermissions = [
				...this.editEmployeeExtraPermissions
			]
	...
	hasPermission(emp: Employee, perm: string): boolean {
		...
		return (
			(role?.permissions.includes(perm) ?? false) ||
			emp.extraPermissions.includes(perm)
		)
	}
